...
clientCode(new MysqlQueryBuilder);  //  SELECT name, email, password FROM users where age > 18 where age > 30 LIMIT 10, 20 
                                    //  SELECT name, email, password FROM users where age > 18 where age > 30 LIMIT 10, 20 
echo "\n\n";

echo "Testing PostgresSQL query builder:\n";
clientCode(new PostgresQueryBuilder);  //  SELECT name, email, password FROM users where age > 18 where age > 30 LIMIT 10 OFFSET 20 
                                       //  SELECT name, email, password FROM users where age > 18 where age > 30 LIMIT 10 OFFSETs 20 