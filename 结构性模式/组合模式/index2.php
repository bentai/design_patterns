...
function getProductForm(): FormElement
{
    ...
    $form->add(new Input('name', "Name", 'text'));  // ['name'] = 'name', "Name", 'text'
    $form->add(new Input('description', "Description", 'text')); // ['description'] = 'description', "Description", 'text'

    $picture = new Fieldset('photo', "Product photo");
    $picture->add(new Input('caption', "Caption", 'text')); // ['caption'] =  'caption', "Caption", 'text'
    $picture->add(new Input('image', "Image", 'file')); // ['image'] =  'image', "Image", 'file'
    $form->add($picture);  // ['photo']
