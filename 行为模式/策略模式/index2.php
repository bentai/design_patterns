...
/**
 * 这是我们应用程序的路由器和控制器。收到请求后，此类决定应执行哪些行为。当应用程序收到付款请求时，
 * OrderController类还将决定应使用哪种付款方法来处理该请求。因此，该类同时充当Context和Client。
...
// {"id":0,"name":"new",email":"me@example.com","product":"ABC Cat food (XL)","total":9.95}
// {"id":1,"name":"new","email":"me@example.com","product":"XYZ Cat litter (XXL)","total":19.95}
...
//    <input type="hidden" id="returnURL" value="https://our-website.com/" .
