...
/**
 * 用户存储库代表一个主题。
 * 各种对象都对跟踪其内部状态感兴趣，无论它是添加新用户还是删除用户。
...
class UserRepository implements \SplSubject
{
    ...
    // 这里是实际的观察者管理基础结构。
    // 请注意，它不是类负责的一切。这些方法下面列出了它的主要业务逻辑。
...
// UserRepository: Broadcasting the user:init event.
// Logger: I've written users:init entry to the log

// UserRepository: Creating a user.
// UserRepository: Broadcasting the user:create event.
// OnboardingNotification: The notification has been emailed!
// Logger: I've written users:create entry to the log

// UserRepository: Deleting a user.
// UserRepository: Broadcasting the user:deleted event.
// Logger: I've written users:create entry to the log
